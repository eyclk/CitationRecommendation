...
main_dataset_folder = "acl_200_ablation_no_title"
...
def concatenate_title_and_abstract_while_making_context_shorter(masked_context, temp_target, ref_id,
    ...
    masked_context_with_global_info = shorter_context_masked + " </s> " + temp_abstract  # *****************************
    ...
    unmasked_context_with_global_info = shorter_context_unmasked + " </s> " + temp_abstract  # *************************
