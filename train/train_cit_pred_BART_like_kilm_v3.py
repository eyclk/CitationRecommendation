...
if __name__ == '__main__':
    ...
    """data = {
        ...
        "validation": [
            {"input": "CONTEXT: experimented with several combination methods , regularization factors, and pre-trained
             word embeddings TARGETCITE . This time, we used cosine similarity  to separate related 
             </s> TARGETCITE: <mask>",
