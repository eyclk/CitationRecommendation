...
dataset_output_file = "new_peerread/context_dataset.csv"
vocab_output_file = "new_peerread/citation_item_list.csv"
train_set_output_file = "new_peerread/context_dataset_train.csv"
eval_set_output_file = "new_peerread/context_dataset_eval.csv"
...
def preprocess_dataset():
    ...
    for i in range(context_df_length):
        ...
        trimmed_masked_context = trim_context_from_both_sides(temp_masked_context)
