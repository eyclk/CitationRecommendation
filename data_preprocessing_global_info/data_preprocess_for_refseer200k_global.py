...
dataset_output_file = "./refseer200k_global/context_dataset.csv"
vocab_output_file = "./refseer200k_global/additions_to_vocab.csv"
train_set_output_file = "./refseer200k_global/context_dataset_train.csv"
eval_set_output_file = "./refseer200k_global/context_dataset_eval.csv"
...
if __name__ == '__main__':
    ...
    print(contexts_df, "\n")
    print(contexts_df.at['citing_id', 9074120800], "\n\n")
    print(contexts_df.at['refid', 9074120800], "\n\n")
    print(contexts_df.at['raw', 9074120800], "\n\n")
    print(contexts_df.at['masked_text', 9074120800], "\n\n")

    papers_df = pd.read_json(papers_file)
    print(papers_df, "\n")
    print(papers_df.columns, "\n")

    if contexts_df.at['citing_id', 9074120800] in papers_df.columns:
        print("\nYES!!!\n")
    if 9074120 in papers_df.columns:
        print("\nYES!!! YES!!!\n")
    if int(contexts_df.at['citing_id', 9074120800]) in papers_df.columns:
        print("\nYES!!! YES!!! YES!!!\n")
    if int(contexts_df.at['refid', 9074120800]) in papers_df.columns:
